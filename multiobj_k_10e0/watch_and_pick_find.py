...
def congwenjianjialistduquzuida(jihelist):
    ...
    for xinwenjianjiaming in jihelist:
        ...
        wenjianming_1 = xinwenjianjiaming +'/' + 'AgentPPO/fuck_0/recorder0.3to0.6_bu0_case1/quan_recorder.npy'
...
while 1:
    ...
    for i in allguys:
        ...
        if os.path.exists(i+'\\3to6\\thebest.png'):
        
            shutil.copy(i+'\\3to6\\thebest.png',i+'.png')
    ...
    if os.path.exists(zuidade_wenjianjia+'\\3to6\\thebest.png'):
    
        shutil.copy(zuidade_wenjianjia+'\\3to6\\thebest.png','fuckisit'+'.png')
    ...
    jiluwenjian = zuidade_wenjianjia + '/3to6/the_best.npy'
