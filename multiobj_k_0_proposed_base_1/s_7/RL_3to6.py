...
for i in range(25):
    ...
    rightzhongreward.append(sec_term_factor**i)


print('rightzhongreward',rightzhongreward)
...
class Fuckingfly:
    ...
    def step(self, action):
        ...
        if done == True:
            ...
            reward = (xishu*shineng_now - 0*self.shineng_last)*xishu2 + 0 + reward_pan_sec + reward_pan + reward_third + reward_forth
...
def shinengjisuan(initial,end,feigao,jietidijibu):
        ...
        if juli <= fenmu*0.5*tolerance:
            ...
            cost_n_weinorm = dangqianbudereward 
